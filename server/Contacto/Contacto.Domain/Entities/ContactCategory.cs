...
public class ContactCategory
{
    ...
    public static readonly ContactCategory ContactCategoryWork = new(Guid.Parse("076B70FE-4E04-4007-B1D2-4516004ACB1D"), "Służbowy", 
        [
            new(Guid.Parse("10977B9D-7547-43CA-86D5-F1C66EA8601A"), "szef", null),
            new(Guid.Parse("21E22646-29C2-445C-ABFE-723469D29AA2"), "klient", null),
            new(Guid.Parse("9CA3E265-692D-4DDF-B3E4-E06D731BF60D"), "współpracownik", null),
        ]
    );
